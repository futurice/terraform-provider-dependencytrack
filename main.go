...
// can be customized.
//go:generate go run github.com/hashicorp/terraform-plugin-docs/cmd/tfplugindocs generate -provider-name dependencytrack
...
func main() {
	...
	opts := providerserver.ServeOpts{
		...
		Address: "registry.terraform.io/futurice/dependencytrack",
		Debug:   debug,
	}
